...
import numpy as np
sys.path.insert(0, '/home/aoberoi1/novelty_stories')

import yaml
import encoders
import scorers

CFG = yaml.safe_load(open('/home/aoberoi1/novelty_stories/config.yaml'))
RUN = Path('/project/jevans/avi/novelty_stories/runs/baseline_greedy')
...
obs_corpora = {n: np.load(f'/project/jevans/avi/novelty_stories/embs/{n}_nyer.npz')['embeddings']
