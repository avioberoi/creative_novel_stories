...
- **Reference**: Oberoi, A. (2026). DURooM: Discovering Unexplored Regions On/Off the Manifold — Novelty search in foundation-model embedding space for visual artifacts. Manuscript / project paper; image-domain precursor to the present work. (Reference: WikiArt experiments at `/home/aoberoi1/novelty_search/extra/paper_sections/`.)
